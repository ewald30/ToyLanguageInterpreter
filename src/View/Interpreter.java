...
//        }
        ...
        try{
            ...
            var semTable10 = new ADTDictionary<Integer, Pair<Integer, List<Integer>>>();
            var ProgramState10 = new ProgramState(executionStack10, symbolTable10, example10, output10, fileTable10, heap10, semTable10);
        ...
        try{
            ...
            var semTable11 = new ADTDictionary<Integer, Pair<Integer, List<Integer>>>();
            var ProgramState11 = new ProgramState(executionStack11, symbolTable11, example11, output11, fileTable11, heap11, semTable11);
        ...
        try{
            ...
            var semTable12 = new ADTDictionary<Integer, Pair<Integer, List<Integer>>>();
            var ProgramState12 = new ProgramState(executionStack12, symbolTable12, example12, output12, fileTable12, heap12, semTable12);
        ...
        var example15 = connectStatements(List.of(
        ...
        var typeEnv15 = new ADTDictionary<String, TypeInterface>();
        try{
            typeEnv15 = (ADTDictionary<String, TypeInterface>)example15.TypeCheck(typeEnv15);
            var output15 = new ADTList<ValueInterface>();                                           //  List containing the output
            var symbolTable15 = new ADTDictionary <String, ValueInterface>();         //  Dictionary containing the symbol table
            var fileTable15 = new ADTDictionary<StringValue, BufferedReader>();   //  Dictionary containing files names and buffered readers
            var executionStack15 = new ADTStack <StatementInterface>();                        //  Stack containing all the statements that have to be executed
            var heap15 = new ADTHeap<Integer, ValueInterface>();
            var semTable = new ADTDictionary<Integer, Pair<Integer, List<Integer>>>();
            var ProgramState15 = new ProgramState(executionStack15, symbolTable15, example15, output15, fileTable15, heap15, semTable);
            var repository15 = new Repository("logfile15.txt");
            var controller15 = new Controller(repository15);
            controller15.addProgram(ProgramState15);
            textMenu.addCommand(new RunExampleCommand("15", example15.toString(), controller15));
        } catch (MyException e){
            System.out.println(e.getMessage());
